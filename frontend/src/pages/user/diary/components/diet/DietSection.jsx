  ...
  <div className="flex flex-wrap gap-2 mb-5">
    {Object.keys(DIET_PRESETS).map((name) => (
      ...
      <button
        ...
        className={`px-3 py-1.5 rounded-full text-xs font-bold border transition-all ${selected === name
  ...
  return (
    <div className="bg-zinc-900/80 backdrop-blur-xl border border-zinc-800 rounded-[32px] p-8 shadow-2xl">
      ...
      <button
        disabled={!isValid}
        onClick={handleSave}
        className={`w-full py-3.5 rounded-2xl font-black text-base transition-all ${isValid
