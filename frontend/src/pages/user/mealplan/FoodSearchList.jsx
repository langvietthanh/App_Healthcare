...
const SearchBar = ({ search, setSearch, Search }) => (
...
const FoodList = ({ activeTab, setIsCreatingFood, handleSelectFood, listFoods, loading, Plus }) => (
...
const FoodSearchList = ({
  ...
  return (
    <>
      <SearchBar search={search} setSearch={setSearch} Search={Search} />
