/**
 * Tác dụng của file: Màn hình nhập cân nặng hiện tại, hỗ trợ đổi đơn vị LBS/KG và nhập số trực tiếp.
...
const StepWeightCurrent = ({
  ...
  return (
    <div className="flex flex-col items-center w-full max-w-sm mx-auto">
      ...
      <WeightInput weight={weight} setWeight={setWeight} unit={weightUnit} />
