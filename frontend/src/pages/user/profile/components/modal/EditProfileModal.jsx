  ...
  return (
    ...
    <div className="fixed inset-0 z-50 flex items-end justify-center">
      ...
      <div className="relative w-full max-w-lg bg-[#1a1a2e] rounded-t-3xl shadow-2xl animate-slideUp max-h-[92vh] flex flex-col">
        ...
        {/* Toast Notification */}
        {toast && (
          <div className={`absolute top-4 left-4 right-4 z-10 flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium shadow-lg animate-fadeIn ${toast.type === 'success'
          ...
          {TABS.map((tab) => {
            ...
            return (
              ...
              <button
                ...
                className={`flex-1 flex items-center justify-center gap-2 py-2.5 rounded-lg text-sm font-semibold transition-all duration-300 ${isActive
                ...
                <div className="grid grid-cols-2 gap-3">
                  {[{ value: 'male', label: 'Nam 🧑' }, { value: 'female', label: 'Nữ 👩' }].map((g) => (
                    ...
                    <button
                      ...
                      className={`py-3 rounded-xl text-sm font-semibold transition-all duration-300 border ${physicalForm.gender === g.value
                ...
                <div className="space-y-2">
                  {ACTIVITY_LEVELS.map((level) => (
                    ...
                    <button
                      ...
                      className={`w-full text-left px-4 py-3 rounded-xl text-sm font-medium transition-all duration-300 border ${physicalForm.activityLevel === level.value
                ...
                <div className="space-y-2">
                  <div className="flex gap-1">
                    {[1, 2, 3, 4].map((level) => (
                      ...
                      <div
                        key={level}
                        className={`h-1 flex-1 rounded-full transition-all duration-300 ${passwordForm.newPassword.length >= level * 3
