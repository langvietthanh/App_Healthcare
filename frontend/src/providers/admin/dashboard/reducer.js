...
import { Users, Utensils, Dumbbell, UserPlus } from 'lucide-react';
...
const initState = {
    ...
    dailyLogCount: [],
    stats: [
        { icon: Users, label: 'Tổng người dùng', value: '0', sub: 'trong hệ thống', color: '#c8f31d' },
        { icon: UserPlus, label: 'Người dùng mới (7d)', value: '0', sub: 'trong hệ thống', color: '#22c55e' },
        { icon: Utensils, label: 'Tổng món ăn', value: '0', sub: 'trong hệ thống', color: '#f97316' },
        { icon: Dumbbell, label: 'Tổng bài tập', value: '0', sub: 'trong hệ thống', color: '#a78bfa' },
    ],
}
